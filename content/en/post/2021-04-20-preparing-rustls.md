...
- [Enforce a no-panic policy](https://github.com/rustls/rustls/issues/447) to eliminate the potential for undefined behavior when Rustls is used across the C language boundary.

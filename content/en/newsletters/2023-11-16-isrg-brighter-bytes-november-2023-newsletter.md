						...
						<table border="0" cellpadding="0" cellspacing="0" id="templateHeader" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #f9f7ed; border-bottom-color: #f9f7ed; border-bottom-style: solid; border-bottom-width: 1px; border-collapse: collapse !important; mso-table-lspace: 0pt; mso-table-rspace: 0pt" width="100%">
							<tbody>
								<tr pardot-repeatable="" style="">
									<td align="left" class="headerContent" pardot-region="header_image" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #505050; font-family: Helvetica; font-size: 20px; font-weight: bold; line-height: 20px; text-align: left; vertical-align: middle; padding: 0;" valign="top"><a href="abetterinternet.org"><img alt="" border="0" height="310" id="headerImage" src="/images/newsletters/2023/2023-11-16-isrg-brighter-bytes-november-2023-newsletter/image-01.png" style="max-width: 600px; outline: none; text-decoration: none; width: 600px; height: 310px; border-width: 0px; border-style: solid;" width="600"></a></td>
								</tr>
							</tbody>
						</table>
						<!-- // END HEADER --></td>
						...
						<table border="0" cellpadding="0" cellspacing="0" id="templateBody" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #f9f7ed; border-bottom-color: #f9f7ed; border-bottom-style: solid; border-bottom-width: 1px; border-collapse: collapse !important; border-top-color: #f9f7ed; border-top-style: solid; border-top-width: 1px; mso-table-lspace: 0pt; mso-table-rspace: 0pt" width="100%">
							<tbody>
								<tr pardot-repeatable="" style="">
									...
									<h3>Celebrating a decade of helping build a more secure Internet</h3>

									<p>In honor of our 10th anniversary, our board Chair, Christine Runnegar, authored an insightful <a href="www.abetterinternet.org/post/board-chair-10th-anniversary/">blog post</a> about ISRG’s journey and contributions since our founding in 2013. She highlights how Let’s Encrypt has transformed Internet security by providing free TLS certificates worldwide, how we’re helping reduce memory safety vulnerabilities in Internet infrastructure through Prossimo, and pioneering privacy-preserving metrics via Divvi Up.<br>
									<br>
									For highlights from the last 10 years and a look at what’s in store for the next 10, take a look at our <a href="www.abetterinternet.org/tenth-anniversary/">anniversary recap</a> by founder and Executive Director Josh Aas.</p>

									<h3>The Beginning of Let's Encrypt</h3>
									Let's Encrypt was <a href="letsencrypt.org/2014/11/18/announcing-lets-encrypt.html">publicly announced</a> on November 18, 2014. Since then, our free TLS certificate authority has come to serve hundreds of millions of websites and help protect just about everyone who uses the Web. In fact, just this month we issued our 4 billionth certificate!</td>
								</tr>
								<tr pardot-repeatable="" style="">
									<td align="left" class="bodyContent" pardot-data="" pardot-region="body_content00" style="text-size-adjust: 100%; color: rgb(80, 80, 80); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; text-align: left; padding: 20px; background: rgb(249, 247, 237);" valign="top">
									...
									<h3>Tectonics 2023: A&nbsp;Productive Convening to Accelerate Memory Safety</h3>

									<p>We are so pleased to share that our inaugural Tectonics&nbsp;event was an invigorating and productive convening on the challenge of advancing memory safety. Leaders like Window Snyder (Thistle Technologies), Doug Gregor (Apple), David Weston (Microsoft), and Fiona Krakenbürger (Sovereign Tech Fund) joined many others for a day-long conversation, moving past the “what” of the memory safety challenge and focusing on the “how.” Check out this <a href="www.memorysafety.org/blog/tectonics-recap/">quick recap</a>, and stay tuned for a more comprehensive series of readouts.​​​<br>
									<img alt="" border="0" height="124" src="/images/newsletters/2023/2023-11-16-isrg-brighter-bytes-november-2023-newsletter/image-02.jpg" style="width: 575px; height: 124px; border-width: 0px; border-style: solid;" width="575"></p>
									</td>
								</tr>
								<tr pardot-repeatable="" style="">
									<td align="left" class="bodyContent" pardot-data="" pardot-region="body_content00" style="text-size-adjust: 100%; color: rgb(80, 80, 80); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; text-align: left; padding: 20px; background: rgb(249, 247, 237);" valign="top">
									...
									<h3 style="line-height: 1.38; margin-bottom: 8px;">IETF 118</h3>

									<p>Divvi Up engineers attended the Privacy Preserving Measurement working group session at <a href="www.ietf.org/how/meetings/118/">IETF 118</a> and helped the <a href="datatracker.ietf.org/doc/draft-ietf-ppm-dap/">Distributed Aggregation Protocol</a> on its way towards standardization.&nbsp;</p>

									<h3>Simplifying Issuance for Very Long Domain Names</h3>

									<p>Starting at the end of this month, Let’s Encrypt will be able to issue certificates where all the DNS names on that certificate are longer than 64 characters. This update removes the limitation that required at least one domain name on the cert to be 64 characters or less to fit into the length-limited “Common Name” field, by issuing certs with no Common Name if none fit. Learn more in <a href="community.letsencrypt.org/t/simplifying-issuance-for-very-long-domain-names/207924">this announcement</a> by Let’s Encrypt engineer Matt McPherrin on our community forum.</p>
									</td>
								</tr>
								<tr pardot-repeatable="" style="">
									<td align="left" class="bodyContent" pardot-data="" pardot-region="body_content00" style="text-size-adjust: 100%; color: rgb(80, 80, 80); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; text-align: left; padding: 20px; background: rgb(249, 247, 237);" valign="top"><h1 style="color: #202020 !important; display: block; font-family: Helvetica; font-size: 26px; font-style: normal; font-weight: bold; letter-spacing: normal; line-height: 26px; margin: 0; padding-bottom:10px; text-align: left"><span style="color:#171347;">New Sponsor Announcement</span></h1>

<h4><img align="right" alt="" border="0" height="51" src="/images/newsletters/2023/2023-11-16-isrg-brighter-bytes-november-2023-newsletter/image-03.jpg" style="width: 200px; height: 51px; border-width: 0px; border-style: solid; float: right;" width="200">We are thrilled to introduce a new Silver sponsor!​</h4>

<div>SecureW2 helps enterprises achieve passwordless security as the first cloud-native solution for customers looking to power security through the policies set in their cloud identities, like Azure AD, Okta, Intune, and Jamf. With SecureW2, you can verify that only trusted users and devices can access your network, applications, and much more.​​​​​</div>

<hr>
<h3>Consider a Sponsorship</h3>

<p>Many organizations are finalizing their 2024 budgets right around this time. If your organization uses or benefits from Let's Encrypt, please consider <a href="abetterinternet.org/sponsor/">becoming a sponsor</a>! Sponsorships provide the majority of our funding, not only for the continued work of Let's Encrypt, but also for projects like Prossimo and Divvi Up. And if you're already a sponsor, then we say thank you for helping us create&nbsp;a more secure and privacy-respecting Internet.</p>
</td>
								</tr>
							</tbody>
						</table>

				...
				<tbody>
						...
						<table border="0" cellpadding="0" cellspacing="0" id="templateHeader" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #f9f7ed; border-bottom-color: #f9f7ed; border-bottom-style: solid; border-bottom-width: 1px; border-collapse: collapse !important; mso-table-lspace: 0pt; mso-table-rspace: 0pt" width="100%">
							<tbody>
								<tr pardot-repeatable="" style="">
									<td align="left" class="headerContent" pardot-region="header_image" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #505050; font-family: Helvetica; font-size: 20px; font-weight: bold; line-height: 20px; text-align: left; vertical-align: middle; padding: 0;" valign="top"><a href="letsencrypt.org/donate/"><img alt="" border="0" height="338" src="/images/newsletters/2024/2024-03-14-introducing-our-new-ct-log-sunlight/image-01.png" style="width: 600px; height: 338px; border-width: 0px; border-style: solid;" width="600"></a></td>
								</tr>
							</tbody>
						</table>
						<!-- // END HEADER --></td>
					...
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" id="templateBody" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #f9f7ed; border-bottom-color: #f9f7ed; border-bottom-style: solid; border-bottom-width: 1px; border-collapse: collapse !important; border-top-color: #f9f7ed; border-top-style: solid; border-top-width: 1px; mso-table-lspace: 0pt; mso-table-rspace: 0pt" width="100%">
							<tbody>
								<tr pardot-repeatable="" style="">
									<td align="left" class="bodyContent" pardot-data="line-height:30px;link-color:#FFA300;" pardot-region="body_content00" style="text-size-adjust: 100%; color: rgb(0, 58, 112); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 20px; line-height: 30px; text-align: left; padding: 20px; background: rgb(249, 247, 237);" valign="top"><span style="color:#000066;"><strong>The days are getting brighter and so is the Web</strong></span><br>
									<span style="color:#ffa300;"><strong>Introducing our new CT Log, Sunlight</strong></span></td>
								</tr>
								<tr pardot-repeatable="" style="">
									<td align="left" class="bodyContent" pardot-data="link-color:#FFA300;" pardot-region="body_content00" style="text-size-adjust: 100%; color: rgb(0, 0, 102); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; text-align: left; padding: 20px; background: rgb(249, 247, 237);" valign="top"><span style="color:#000066;">The sky’s the limit for the number of free TLS certs we’ll issue — we recently jumped to issuing over 4 million <em>each day</em>, and that number will only rise. Knowing how important Certificate Transparency (CT) is to the Web PKI, we recognized the need for a CT log that’s optimized to meet this demand.</span><br>
									<br>
									<em><strong>Cue our new CT log, Sunlight! </strong></em>Built in partnership with Filippo Valsorda and with feedback from the broader community, Sunlight is easier to operate than its predecessor Oak and is backed by a consistent object storage. Plus, it can scale to 30 times our current issuance rate and has a slew of other improvements.&nbsp;<br>
									​​​​​<br>
									Learn more about Sunlight in this blog post:&nbsp;<a href="letsencrypt.org/2024/03/14/introducing-sunlight" style="color: #ffa300;"><span style="color:#000066;">letsencrypt.org/2024/03/14/introducing-sunlight</span></a><br>
									<br>
									It’s thanks to supporters like you that our team is able to innovate and improve Let’s Encrypt to make the Internet brighter for everyone, everywhere. <strong>Please consider donating to our Brighter Days campaign today. For gifts of $100 or more, you’ll receive a Let’s Encrypt hoodie!</strong><br>
									<br>
